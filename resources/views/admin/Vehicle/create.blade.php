            ...
            <div class="animate__animated p-6" :class="[$store.app.animation]">
                ...
                <div x-data="form">
                    <ul class="flex space-x-2 rtl:space-x-reverse">
                        <li>
                            <a href="javascript:;" class="text-primary hover:underline">Create Category</a>
                        </li>
                    ...
                    <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
                        ...
                        <div class="panel">
                            ...
                            <div class="mb-5">
                                ...
                                <form class="space-y-5" action="{{ route('vehicle-categories.store') }}" method="POST">
                                    @csrf
                                    <div>
                                        <input type="text" name="group_name" placeholder="Enter Category"
                                            class="form-input" required>
                                        <span class="mt-1 inline-block text-[11px] text-white-dark">We'll never share
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <a href="{{ route('vehicle-categories.index') }}"
                                            class="btn btn-secondary">Cancel</a> <!-- Link to categories list -->

                        ...
                        <ul class="horizontal-menu hidden border-t border-[#ebedf2] bg-white py-1.5 px-6 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-[#0e1726] dark:text-white-dark lg:space-x-1.5 xl:space-x-8">
                            ...
                            <li class="menu nav-item relative">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="forms-layouts.html" class="active">Layouts</a>
                                    </li>
                                    <li>
                ...
                <div class="animate__animated p-6" :class="[$store.app.animation]">
                    ...
                    <div x-data="form">
                        <ul class="flex space-x-2 rtl:space-x-reverse">
                            <li>
                                <a href="javascript:;" class="text-primary hover:underline">Edit Category</a>
                            </li>
                        ...
                        <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
                            ...
                            <div class="panel">
                                ...
                                <!-- Success message -->
                                @if(session('success'))
                                    <div class="bg-success-500 text-white text-sm p-3 rounded-md mb-5">
                                        {{ session('success') }}
                                    </div>
                                @endif
                                ...
                                @enderror
                                    ...
                                    <form class="space-y-5" action="{{ route('vehicle-categories.update', $vehicleCategory->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div>
                                            <input type="text" name="group_name" placeholder="{{ $vehicleCategory->group_name}}" disabled class="form-input" required>
                                        ...
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <a href="{{ route('vehicle-categories.index') }}" class="btn btn-secondary">Cancel</a> <!-- Link to categories list -->

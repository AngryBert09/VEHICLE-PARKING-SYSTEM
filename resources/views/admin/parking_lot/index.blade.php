                ...
                <div x-data="contacts">
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        ...
                        <div class="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
                            <div class="flex gap-3">
                                <div>
                                    <form action="{{ route('parking-lots.create') }}" method="GET">
                    ...
                    <div class="panel mt-5 overflow-hidden border-0 p-0">
                        <template x-if="displayType === 'list'">
                            <div class="table-responsive overflow-x-auto" style="max-height: 400px;">
                                <style>
                                ...
                                <table class="table-striped table-hover min-w-full">
                                    ...
                                    <tbody>
                                        @foreach ($parkingSlots as $parkingSlot)
                                            <tr>
                                                <td class="whitespace-nowrap">{{ $parkingSlot->slot_name }}</td>
                                                <td class="whitespace-nowrap">
                                                    @if ($parkingSlot->status == 'active')
                                                        <span class="badge bg-success">Active</span>
                                                    @else
                                                        <span class="badge bg-danger">Inactive</span>
                                                    @endif
                                                </td>
                                                <td class="whitespace-nowrap">{{ $parkingSlot->vehicle_type }}</td>
                                                <td class="whitespace-nowrap">
                                                    @if (strtolower($parkingSlot->availability) == 'occupied')
                                                        <span class="badge bg-danger">Occupied</span>
                                                    @elseif(strtolower($parkingSlot->availability) == 'available')
                                                        <span class="badge bg-success">Available</span>
                                                    @elseif(strtolower($parkingSlot->availability) == 'reserved')
                                                ...
                                                <td>
                                                    <div class="flex items-center justify-center gap-4">
                                                        <!-- Check if the user is an admin or an attendant -->
                                                        @if (Auth::user()->roles === 'admin' ||
                                                                (Auth::user()->roles === 'attendant' &&
                                                                    (strtolower($parkingSlot->availability) === 'available' ||
                                                                        strtolower($parkingSlot->availability) === 'reserved')))
                                                            <!-- Edit Button -->
                                                            <a href="{{ route('parking-lots.edit', $parkingSlot->id) }}"
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form
                                                            action="{{ route('parking-lots.destroy', $parkingSlot->id) }}"

            ...
            <div class="animate__animated p-6" :class="[$store.app.animation]">
                ...
                <div x-data="form">
                    <ul class="flex space-x-2 rtl:space-x-reverse">
                        <li>
                            <a href="javascript:;" class="text-primary hover:underline">Edit slot</a>
                        </li>
                    ...
                    <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
                        ...
                        <div class="panel">
                            <div class="mb-5 flex items-center justify-between">
                                <h5 class="text-lg font-semibold dark:text-white-light">Edit Parking Lot</h5>
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <form class="space-y-5" action="{{ route('parking-lots.update', $parkingLot->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div>
                                        <input type="text" name="slot_name"
                                            placeholder="{{ $parkingLot->slot_name }}" disabled class="form-input"
                                            required>
                                        <span class="mt-1 inline-block text-[11px] text-white-dark">Make sure its
                                            unique</span>
                                    </div>
                                    <div>
                                        <label for="category"
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <a href="{{ route('parking-lots.index') }}" class="btn btn-secondary">Cancel</a>

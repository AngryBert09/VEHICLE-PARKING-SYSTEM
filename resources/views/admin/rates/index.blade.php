            ...
            <div class="animate__animated p-6" :class="[$store.app.animation]">
                ...
                <div x-data="contacts">
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        <h2 class="text-xl">Rates</h2>
                        <div class="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
                            <div class="flex gap-3">
                                <div>
                                    <form action="{{ route('rates.create') }}" method="GET">
                                ...
                                <table class="table-striped table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($rates as $rate)
                                            <tr>
                                                <td class="whitespace-nowrap">{{ $rate->rate_name }}</td>
                                                <td class="whitespace-nowrap">
                                                    {{ $rate->vehicleCategory ? $rate->vehicleCategory->group_name : 'No Category' }}
                                                </td>
                                                <td class="whitespace-nowrap">{{ $rate->type }}</td>
                                                <td class="whitespace-nowrap">{{ $rate->rate }}</td>
                                                <td class="whitespace-nowrap">

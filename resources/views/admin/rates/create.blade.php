            ...
            <div class="animate__animated p-6" :class="[$store.app.animation]">
                ...
                <div x-data="form">
                    <ul class="flex space-x-2 rtl:space-x-reverse">
                        <li>
                            <a href="javascript:;" class="text-primary hover:underline">Create Rates</a>
                        </li>
                    ...
                    <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
                        ...
                        <div class="panel">
                            <div class="mb-5 flex items-center justify-between">
                                <h5 class="text-lg font-semibold dark:text-white-light">Create Rate</h5>
                            </div>

                            <!-- Success message -->
                            @if (session('success'))
                                <div class="bg-success text-white text-sm p-3 rounded-md mb-5">
                                    {{ session('success') }}
                                </div>
                            @endif
                            ...
                            <div class="mb-5">
                                ...
                                @enderror
                                <!-- Form to create a new rate -->
                                <form class="space-y-5" action="{{ route('rates.store') }}" method="POST">
                                    @csrf
                                    <!-- Rate Name -->
                                    <div>
                                        <label for="rate_name" class="block text-sm font-medium text-gray-700">Rate
                                            Name</label>
                                        <input type="text" id="rate_name" name="rate_name"
                                            placeholder="Enter Rate Name" class="form-input" required>
                                        <span class="mt-1 inline-block text-[11px] text-white-dark">Enter your rate
                                            name</span>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-input" id="category" name="category" required>
                                            ...
                                            @foreach ($vehicleCategories as $category)
                                                <option value="{{ $category->id }}">{{ $category->group_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <!-- Cancel button (redirects to rates list or previous page) -->

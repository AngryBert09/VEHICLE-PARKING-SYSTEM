        ...
        <div class="main-content flex flex-col min-h-screen">
            ...
            <div class="animate__animated p-6" :class="[$store.app.animation]">
                ...
                <div x-data="contacts">
                    ...
                    @if (session('success'))
                        <div
                            class="bg-success text-white text-sm p-4 rounded-md mb-5 mt-5 flex items-center justify-between transition-all duration-300 ease-in-out transform hover:scale-105">
                    ...
                    @if (session('error'))
                        <div
                            class="bg-danger text-white text-sm p-4 rounded-md mb-5 mt-5 flex items-center justify-between transition-all duration-300 ease-in-out transform hover:scale-105">
                            <div class="flex items-center">
                                <!-- Error Icon -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">

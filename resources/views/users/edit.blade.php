            ...
            <div class="animate__animated p-6" :class="[$store.app.animation]">
                ...
                <div x-data="form">
                    <ul class="flex space-x-2 rtl:space-x-reverse">
                        <li>
                            <a href="javascript:;" class="text-primary hover:underline">Edit User</a>
                        </li>
                        ...
                        <div class="panel">
                            ...
                            <div class="mb-5">
                                ...
                                <form class="space-y-5" action="{{ route('users.update', $user->id) }}" method="POST">
                                    @csrf
                                    @method('PUT') <!-- This is important for sending PUT requests in forms -->

                                    <!-- Email field (disabled) -->
                                    <div>
                                        <input type="email" name="email" value="{{ $user->email }}"
                                            class="form-input" disabled>
                                        <span class="mt-1 inline-block text-[11px] text-white-dark">Make sure it's
                                            unique</span>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-input" name="role" required>
                                            ...
                                            <option value="customer"
                                                {{ $user->roles === 'customer' ? 'selected' : '' }}>
                                                Customer</option>
                                            <option value="attendant"
                                                {{ $user->roles === 'attendant' ? 'selected' : '' }}>
                                                Attendant</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <!-- Cancel button (redirects to users list) -->

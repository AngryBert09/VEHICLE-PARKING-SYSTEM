                    ...
                    <div
                        ...
                        <div class="mx-auto w-full max-w-[440px]">
                            ...
                            <form class="space-y-5 dark:text-white" method="POST"
                                ...
                                @if (session('success'))
                                    <div class="text-success text-sm mt-2">{{ session('success') }}</div>
                                @endif

                                @if ($errors->has('error'))
                                    <div class="text-danger text-sm mt-2">{{ $errors->first('error') }}</div>
                                @endif
                                ...
                                <div>
                                    ...
                                    <div class="relative text-white-dark">
                                        <input id="Name" name="name" type="text" placeholder="Enter Name"
                                            class="form-input ps-10 placeholder:text-white-dark @error('name') border-red-500 @enderror"
                                            required>
                                    ...
                                    @error('name')
                                        ...
                                        <!-- Ensure red styling is applied here -->
                                    @enderror
                                </div>

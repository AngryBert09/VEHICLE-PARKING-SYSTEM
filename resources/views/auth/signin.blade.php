    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark">
        <div x-data="auth">
            ...
            <div
                ...
                <img src="{{ asset('images/auth/polygon-object.svg') }}" alt="image"
                        ...
                        <div class="mx-auto w-full max-w-[440px]">
                            <div class="mb-10">
                                ...
                                <p class="text-base font-bold leading-normal text-white-dark">Enter your email and
                                    password to login</p>
                                @if (session('success'))
                                    <div class="mb-1 p-4 text-white bg-success rounded-md">
                                        {{ session('success') }}
                                    </div>
                                @endif
                            </div>
                            <form class="space-y-5 dark:text-white" method="POST"
                                ...
                                <div>
                                    ...
                                    <div class="relative text-white-dark">
                                        ...
                                        <span class="absolute end-4 top-1/2 -translate-y-1/2 cursor-pointer ml-3"
                                            onclick="togglePasswordVisibility()">
                                            <!-- Eye Icon for toggling visibility -->
                                            <svg id="show-icon" width="18" height="18" viewBox="0 0 18 18"
                                                fill="none">
                                                <path d="M1 9C1 9 4 4 9 4C14 4 17 9 17 9C17 9 14 14 9 14C4 14 1 9 1 9Z"
                                                    stroke="currentColor" stroke-width="1.5" />
                                                <circle cx="9" cy="9" r="2.5" fill="currentColor" />
                                            </svg>
                                            <svg id="hide-icon" width="18" height="18" viewBox="0 0 18 18"

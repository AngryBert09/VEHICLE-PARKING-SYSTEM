        ...
        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                <a href="index.html" class="main-logo flex shrink-0 items-center">
                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="images/default.jpg" alt="image">
                    <span
            ...
            <div x-data="header"
                ...
                <div class="sm:ltr:mr-auto sm:rtl:ml-auto" x-data="{ search: false }" @click.outside="search = false">
                    <div x-data="searchHandler()" class="relative">
                        <form
                            class="absolute inset-x-0 top-1/2 z-10 mx-4 hidden -translate-y-1/2 sm:relative sm:top-0 sm:mx-0 sm:block sm:translate-y-0"
                            :class="{ '!block': search }" @submit.prevent="handleSearch">
                            <div class="relative">
                        ...
                        <script>
                            function searchHandler() {
                                return {
                                    ...
                                    search: false, // Toggles the search box visibility
                                    handleSearch() {
                                        const routes = {
                                        ...
                                        if (routes[normalizedQuery]) {
                                            window.location.href = routes[normalizedQuery];
                                        } else {
                                            alert('No matching page found. Please refine your search.');
                                        }
                                    },
                                };
                            }
                ...
                {{-- NOTIFICATIONS --}}
                <div class="dropdown" x-data="dropdown" x-init="init()" @click.outside="open = false">
                    <a href="javascript:;"
                    ...
                    <ul x-cloak="" x-show="open" x-transition="" x-transition.duration.300ms=""
                        class="top-11 max-h-[300px] w-[300px] overflow-y-auto divide-y !py-0 text-dark ltr:-right-2 rtl:-left-2 dark:divide-white/10 dark:text-white-dark sm:w-[350px]">
                        <li>
                            <div
                                ...
                                @else
                                    <span class="badge bg-danger/80">No access to notifications</span>
                                @endif
                            </div>
                        </li>
                        <!-- Admin notifications -->
                                ...
                                <li class="dark:text-white-light/90">
                                    <div class="group flex items-center px-4 py-2" @click.self="toggle">
                                        ...
                                        <div class="flex flex-auto ltr:pl-3 rtl:pr-3">
                                            <div class="ltr:pr-3 rtl:pl-3" x-data="{ authUserId: {{ auth()->user()->id }} }">
                                                <template x-if="notification.data.user_id === authUserId">
                                                    <p class="text-white">
                                                        Your earnings have been updated to
                                                        <span
                                                            x-text="parseFloat(notification.data.amount).toFixed(2)"></span>.
                                                    </p>
                                                </template>
                                                <template x-if="notification.data.user_id !== authUserId">
                        ...
                        @else
                            ...
                            <li>
                                <div class="!grid min-h-[200px] place-content-center text-lg hover:!bg-transparent">
                                    <p class="text-center text-lg text-danger">No access to notifications</p>
                                </div>
                            </li>
                        @endif
                    </ul>
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="group relative" @click="toggle()">
                        <span><img class="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100"
                                src="{{ asset('images/default.jpg') }}" alt="image"></span>
                    </a>
                    <ul x-cloak="" x-show="open" x-transition="" x-transition.duration.300ms=""
